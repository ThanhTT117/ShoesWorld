	...
	<div class="top-header navbar navbar-default">
		...
		<div class="container">
			<div class="nav navbar-nav wow fadeInLeft animated" data-wow-delay=".5s">
				<p>
					Chào mừng đến với <a>Shoes World</a> <a href="admin">Đăng Nhập </a>
				</p>
			</div>
			<div
								...
								<div class="row">
									<div class="col-sm-4 menu-grids">
										<ul class="multi-column-dropdown">
											<li><a class="list" href="#">dây giày</a></li>
											<li><a class="list" href="#">Miếng lót giày</a></li>
									...
									<div class="col-sm-8 menu-grids">
										<a href="products.html">
											<div class="new-add">
												<img src="static/images/banner/banner.jpg" />
											</div>
										</a>
									</div>
									<div class="clearfix"></div>
						...
						<li class="dropdown grid"><a href="#" class="dropdown-toggle list1"
							...
							<ul class="dropdown-menu multi-column menu-two multi-column3">
								<div class="row">
									<div class="col-sm-4 menu-grids">
										<ul class="multi-column-dropdown">
											<li><a class="list" href="#">Sửa Giaỳ
													</a></li>
											<li><a class="list" href="#">Custom Giay</a></li>
