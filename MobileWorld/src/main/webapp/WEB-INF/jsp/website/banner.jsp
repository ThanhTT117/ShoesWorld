...
<div class="banner">
	<div class="container">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1800px;height:800px;overflow:hidden;">
            <div>
                <img data-u="image" src="static/images/slider/bannerad.jpg" />
            </div>
            <div>
                <img data-u="image" src="static/images/slider/bannercv.jpg" />
            </div>
            <div>
                <img data-u="image" src="static/images/slider/bannernike.jpg" />
            </div>
