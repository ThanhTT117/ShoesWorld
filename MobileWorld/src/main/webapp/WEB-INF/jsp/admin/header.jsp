...
<header class="main-header">
	...
	<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini"><b>Shoes World</b></span> <!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><b>Shoes</b>World</span>
	</a>
						...
						<li>
							...
							<ul class="menu">
								...
								<li><a href="#">
										...
										<h4>
											Admin <small><i class="fa fa-clock-o"></i> 2 hours</small>
										</h4>
										<p>Why not buy a new awesome theme?</p>
								</a></li>
								<li><a href="#">
